...
#define PanSource	"lock_step.pml"
...
#define _nstates5	14	/* upEventually */
#define minseq5	122
#define maxseq5	134
#define _endstate5	13

#define _nstates4	19	/* User */
#define minseq4	104
#define maxseq4	121
#define _endstate4	18

#define _nstates3	26	/* Loader */
#define minseq3	79
#define maxseq3	103
#define _endstate3	25

#define _nstates2	29	/* Player */
#define minseq2	51
#define maxseq2	78
#define _endstate2	28

#define _nstates1	24	/* Lamp */
#define minseq1	28
#define maxseq1	50
#define _endstate1	23

#define _nstates0	29	/* Go */
#define minseq0	0
#define maxseq0	27
...
typedef struct P5 { /* upEventually */
...
#define PUser	((P4 *)_this)
typedef struct P4 { /* User */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
...
#define PLoader	((P3 *)_this)
typedef struct P3 { /* Loader */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
...
#define PPlayer	((P2 *)_this)
typedef struct P2 { /* Player */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
...
#define PLamp	((P1 *)_this)
typedef struct P1 { /* Lamp */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
...
typedef struct State {
	...
	#endif
#endif
	unsigned startUser : 1;
	unsigned endUser : 1;
	unsigned upIssued : 1;
	unsigned upPerformed : 1;
	unsigned startLamp : 1;
	unsigned startPlayer : 1;
	unsigned startLoader : 1;
	uchar currentEV;
	uchar stateLamp;
	uchar statePlayer;
	uchar stateLoader;
