...
#define PanSource	"controller_robot.pml"
...
#define _nstates2	22	/* Robot */
#define minseq2	39
#define maxseq2	59
#define _endstate2	21

#define _nstates1	33	/* Controller */
#define minseq1	7
#define maxseq1	38
#define _endstate1	32

#define _nstates0	8	/* User */
#define minseq0	0
#define maxseq0	6
#define _endstate0	7
...
#define PRobot	((P2 *)_this)
typedef struct P2 { /* Robot */
